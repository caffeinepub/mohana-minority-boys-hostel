    ...
    <div>
      ...
      <div className="hero-pattern py-12 px-4">
        ...
        >
          ...
          <p className="text-white/60 font-body max-w-xl mx-auto text-sm leading-relaxed">
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <Alert className="mb-8 border-[oklch(var(--saffron)/0.4)] bg-[oklch(var(--saffron)/0.05)]">
            ...
            <AlertDescription className="font-body text-sm text-foreground">
              <strong>Important:</strong> Admission is completely free. All
              hostel charges, electricity, water, and maintenance are borne by
              the Government of Odisha. Only nominal mess fees apply for food
          ...
          <Alert className="border-border bg-muted/50">
            ...
            <AlertDescription className="font-body text-sm text-muted-foreground">
              For admission-related queries, contact the Hostel Superintendent
              at +91 9876543210 or email pmmbh.mohana@odisha.gov.in. Walk-in
